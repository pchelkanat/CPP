========================================================================
    КОНСОЛЬНОЕ ПРИЛОЖЕНИЕ. Обзор проекта Тагиров. Задача с вагонами 2
========================================================================

Это приложение Тагиров. Задача с вагонами 2 создано автоматически с помощью мастера приложений.

В этом файле представлена сводка содержимого всех файлов, входящих в состав приложения Тагиров. Задача с вагонами 2.


Тагиров. Задача с вагонами 2.vcxproj
...
Тагиров. Задача с вагонами 2.vcxproj.filters
...
Тагиров. Задача с вагонами 2.cpp
...
StdAfx.h, StdAfx.cpp
    Эти файлы используются для построения файла предкомпилированного заголовка (PCH) с именем Тагиров. Задача с вагонами 2.pch и файла предкомпилированных типов с именем StdAfx.obj.
